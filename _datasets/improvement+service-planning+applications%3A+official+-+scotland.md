...
notes: "<p>This planning application data has been created using a custom built 'Cloud\
  \ Connector Framework' which enables the automated collection of data from local\
  \ data systems.   There are 2 layers: Points &amp; Polygons (East Ayrshire's polygon\
  \ data is buffered points)  ALL 34 PLANNING AUTHORITIES ARE NOW PROVIDING DATA ON\
  \ A DAILY BASIS  'Development management' is the name given to the process of deciding\
