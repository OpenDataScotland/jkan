...
notes: "<p>This new planning applications data has been created using a custom built\
  ...
  \ Polygons.</p>\n<p>Currently missing data from Western Isles</p>\n<p>'Development\
  ...
  \ size you should use it with a filter. For example with the attributes 'local_authority'.</p>\n\
  <p>A powerBI dashboard highlighting some data quality issues we have found is available\
  \ to view at https://shorturl.at/lGqrh</p>"
