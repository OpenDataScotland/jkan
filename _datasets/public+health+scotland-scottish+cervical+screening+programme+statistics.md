...
notes: <p>This dataset provides annual cervical screening statistics in Scotland,
  ...
  this publication series is currently under review due to recent identification of
  data quality issues. Users should be aware that the previously published estimates
  might be inaccurate. We are currently assessing the impact of the quality issues
  on the published statistics and will update this note when that work is complete.
  \r\n\r\nWe are also currently working to develop new statistics that will better
  reflect how screening services are now delivered. Future publications based on this
  data will be treated as \u2018Official Statistics in development\u2019 and updated
  publication plans will be announced on the PHS Forthcoming Publications webpage.
  PHS have informed the Office for Statistics Regulation (OSR) of this work. \r\n\r\nAs
  we look to improve future publication of the data, we welcome all feedback from
  users. Please contact the team at phs.cancerstats@phs.scot.\r\n\r\nFurther information
