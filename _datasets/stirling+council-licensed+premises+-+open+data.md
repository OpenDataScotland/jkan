...
notes: '<div>Please Note: This dataset originates from a system export which contains
  no coordinate information. We take this extract and process it against our own gazetteer
  (official list of property addresses) to create a location point. Some errors do
  exist in the positions of the premises points, where mis-matched address information
  exists, however, as we develop this dataset the accuracy will improve.</div>
