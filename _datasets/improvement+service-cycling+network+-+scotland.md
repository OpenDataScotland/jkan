...
notes: "<p>Many local authorities capture details of the cycle network within their\
  ...
  \ organisations.  We have now also added the Scottish part of the Walk Wheel Cycle\
  \ Trust's National Cycle Network dataset (which will now be available via an OGC\
