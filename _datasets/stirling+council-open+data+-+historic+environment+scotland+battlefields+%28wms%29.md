...
notes: '<div><b>This dataset is published as Open Data</b></div>
  ...
  <div>https://inspire.hes.scot/arcgis/services/HES/Battlefields_Inventory_Boundary/MapServer/WMSServer?service=WMS</div>'
organization: Stirling Council
original_dataset_link: https://data-stirling-council.hub.arcgis.com/maps/stirling-council::open-data-historic-environment-scotland-battlefields-wms
records: null
resources:
- format: ARCGIS HUB DATASET
  name: Web Page
  url: https://data-stirling-council.hub.arcgis.com/maps/stirling-council::open-data-historic-environment-scotland-battlefields-wms
- format: ARCGIS GEOSERVICE
  name: Esri REST
  url: https://inspire.hes.scot/arcgis/services/HES/Battlefields_Inventory_Boundary/MapServer/WMSServer?version=1.3.0
schema: default
title: Open data - historic environment scotland battlefields (wms)
---
