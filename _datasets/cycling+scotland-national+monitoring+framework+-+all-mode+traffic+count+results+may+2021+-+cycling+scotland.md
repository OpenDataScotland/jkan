...
notes: <p>"All-mode traffic data from 48-hour counts across Scotland in May 2021."</p>
...
resources:
- format: CSV
  name: National Monitoring Framework - all-mode traffic count results May 2021 -
...
schema: default
title: National Monitoring Framework - all-mode traffic count results May 2021 - Cycling
  Scotland
---
