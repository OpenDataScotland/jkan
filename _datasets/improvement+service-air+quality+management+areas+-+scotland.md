...
notes: <p>Local Authorities have a duty to designate any relevant areas where the
  ...
  that area. AQMAs can be for a combination of NO2, SO2, PM10.  Data provided by local
  authorities is in polygon format. Dundee Council, use the entire extent of their
  local authority, as digitised in Ordnance Survey's BoundaryLine dataset, for the
  AQMA.  We have included date of AQMA declaration in our national schema, though
  many LAs do not currently provide this.</p>
