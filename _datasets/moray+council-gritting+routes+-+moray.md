...
original_dataset_link: ' https://data.spatialhub.scot/dataset/gritting_routes-mo'
records: null
resources:
- format: WFS
  name: Winter Gritting Carriageway Priority 1 and 2 Only
  url: https://mapping.moray.gov.uk/arcgis/services/INSPIRE/INSPIRE/MapServer/WFSServer?request=GetCapabilities&service=WFS
schema: default
title: Gritting Routes - Moray
---
