...
original_dataset_link: ' https://data.spatialhub.scot/dataset/car_parking-fa'
records: null
resources:
- format: REST
  name: Car Park polygons
  url: https://services5.arcgis.com/2A1rJB9Piphr2k5E/arcgis/rest/services/Car_Parks_(PwO)/FeatureServer/0/query?outFields=*&where=1%3D1
schema: default
