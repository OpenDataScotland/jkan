...
license: '"A real-time hourly upload from each cycling counter within Stirling Council''s
  network."'
...
schema: default
title: Perth and Kinross - Hourly cycling counts from automatic cycling counters
---
