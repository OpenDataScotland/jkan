...
notes: "<p>Babies' first forenames by Council area, 2018 based on the records for\
  ...
  \  Notes -\_  a)\_each list covers first forenames given to 3+ babies of that sex\
  \ in the specified council area (so OMITS first forenames given to only 1-2 babies\
