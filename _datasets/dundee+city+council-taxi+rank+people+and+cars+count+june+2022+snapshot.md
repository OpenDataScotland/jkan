...
notes: "<div><font size='4'><b><u>Taxi Rank People and Cars Count</u></b></font></div>\n\
  <div><br /></div>\n<div>This data set is sourced from Dundee City Council\u2019\
  s Public Space Camera Surveillance System. It shows a count of people and cars within\
  \ a specified area on Nethergate/Marketgait West (Camera 321). The data set shows\
  \ a count of people and cars within this specified area every Monday, Wednesday\
...
original_dataset_link: https://data.dundeecity.gov.uk/datasets/dundeecity::taxi-rank-people-and-cars-count-june-2022-snapshot
records: null
resources:
