...
- format: CSV
  name: CSV
  url: https://data-stirling-council.hub.arcgis.com/api/download/v1/items/be0b012a2dda467482810c9e2f7daf78/csv?layers=0
- format: GEOJSON
  name: GeoJSON
  url: https://data-stirling-council.hub.arcgis.com/api/download/v1/items/be0b012a2dda467482810c9e2f7daf78/geojson?layers=0
schema: default
