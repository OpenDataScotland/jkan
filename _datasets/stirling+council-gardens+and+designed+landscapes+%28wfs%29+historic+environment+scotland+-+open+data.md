...
original_dataset_link: https://data-stirling-council.hub.arcgis.com/maps/stirling-council::gardens-and-designed-landscapes-wfs-historic-environment-scotland-open-data
records: null
resources:
- format: ARCGIS HUB DATASET
  name: Web Page
  url: https://data-stirling-council.hub.arcgis.com/maps/stirling-council::gardens-and-designed-landscapes-wfs-historic-environment-scotland-open-data
- format: ARCGIS GEOSERVICE
  name: Esri REST
  url: https://inspire.hes.scot/arcgis/services/HES/HES_Designations/MapServer/WFSServer
schema: default
title: Gardens and designed landscapes (wfs) historic environment scotland - open
  data
---
