...
original_dataset_link: https://data.spatialhub.scot/dataset/school_catchments-an
records: null
resources:
- format: WFS
  name: Primary School Catchments
  url: https://angus.maps.xmap.cloud/angus_public/primary_school_catchment/wfs
- format: WFS
  name: Denominational Primary School Catchments
  url: https://angus.maps.xmap.cloud/angus_public/denominational_primary_school_catchment/wfs
- format: WFS
  name: Secondary School Catchments
  url: https://angus.maps.xmap.cloud/angus_public/secondary_school_catchment/wfs
schema: default
title: School Catchments - Angus
---
