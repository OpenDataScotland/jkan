...
notes: '<p>Each local authority creates gritting routes and regimes to keep their
  ...
  <p>We now have two layers: one for road gritting and one for footpath.</p>

  <p>Some LAs collect this data as a polygon dataset. We are working with them to
  convert this into line formats in the future.</p>
